...
# ================= BUTTONS ================
# S0_send
set_property PACKAGE_PIN R11 [get_ports S0_send]
set_property IOSTANDARD LVCMOS33 [get_ports S0_send]

# S3_confirm
set_property PACKAGE_PIN V1 [get_ports S3_confirm]
set_property IOSTANDARD LVCMOS33 [get_ports S3_confirm]
...
# UART RX 
# FPGA 接收 PC 发送的数据，uart_rx 接收端口
set_property PACKAGE_PIN N5 [get_ports uart_rx]
set_property IOSTANDARD LVCMOS33 [get_ports uart_rx]

# UART TX 
# FPGA 发送数据到 PC，uart_tx 发送端口
